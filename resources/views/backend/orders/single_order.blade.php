...
<div class="content-wrapper"> 
  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row">
        ...
        <form action="{{url('admin/updateOrder')}}" method="post" onsubmit="return cancelOrder();" class="form-horizontal" enctype="multipart/form-data">

               <input type="hidden" name="orders_id" value="{{$data['orders_data'][0]->orders_id}}" class="form-control" id="orders_id">
             <input type="hidden" name="old_orders_status" value="{{$data['orders_data'][0]->orders_status_id}}" id="old_orders_status" class="form-control">
             <input type="hidden" name="customers_id" value="{{$data['orders_data'][0]->customers_id}}" id="device_id">
