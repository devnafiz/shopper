        ...
        <ul class="list">
            <li>
                <div class="user-info">
                    ...
                    <div class="detail">
                        ...
                        <small>{{ trans('labels.admin') }}</small>                        
                    </div>
                </div>
            </li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Category</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="ticket-list.html">Subcategory List</a></li>
                    <li><a href="{{url('admin/addsubcategory')}}">Add SubCategory</a></li>
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>News</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('admin/news')}}">News</a></li>
                    <li><a href="{{url('admin/newscategories')}}">New Category</a></li>
                    
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Banner</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('admin/addbanner')}}">Add Banner</a></li>
                    <li><a href="{{url('admin/banners')}}">Banner  List</a></li>
                    <li><a href="blog-list.html">List View</a></li>
                    <li><a href="blog-grid.html">Grid View</a></li>
                    <li><a href="blog-details.html">Blog Details</a></li>
                </ul>
            </li>
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Products</span></a>
                <ul class="ml-menu">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Website(setting)</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('admin/sliders')}}">Sliders</a></li>                    
                    <li><a href="{{url('admin/pages')}}">All Page</a></li>                    
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-flower"></i><span>Manage Admins</span></a>
                <ul class="ml-menu">
                    <li><a href="{{url('admin/admins')}}">Admin List</a></li>
                    <li><a href="{{url('admin/manageroles')}}">Manage Role</a></li>
                    
                </ul>
            </li>
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>General Setting</span></a>
                <ul class="ml-menu">
