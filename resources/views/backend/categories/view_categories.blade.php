                                    ...
                                    <tr>
                                       ...
                                       <td><img src="{{asset('').'/'.$category->icon}}" alt="" width=" 100px"></td>
                                        ...
                                        <td>
                                            ...
                                            <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editcategory/{{ $category->id }}" class="badge bg-light-blue"><i class="zmdi zmdi-edit" aria-hidden="true"></i></a> 
                            <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" href="deletecategory/{{ $category->id }}" class="badge bg-red"><i class="zmdi zmdi-delete" aria-hidden="true"></i></a>
