											...
											<div class="col-lg-7 col-md-7">
												...
												<div class="block-content">
													...
													<div class="mc4wp-form-fields">
														<div class="input-box">
															<input type="email" name="email" title="Sign up for our newsletter" class="newsletter input-text required-entry validate-email" placeholder="@lang('website.Your email address here')" required="required" />
														</div>
					...
					<div class="footer-bottom">
						<div class="footer-bottom-content container clearfix">
							<div class="copyright-footer pull-left">
								<br/>Designed by <a href="http://www.shoppersmaaza.com">Shoppersmaaza.Com</a>				
							</div>
