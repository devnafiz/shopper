...
class AdminCategoriesController extends Controller
{
	...
	public function categories(){
		...
		return view("backend.categories.view_categories",$title)->with('categories', $categories);
		}
	}
	...
	public function addcategory(Request $request){
		...
		return view("backend.categories.add_category",$title)->with('result', $result);
	}
	...
	public function addnewcategory(Request $request){
		...
		if($request->hasFile('newImage') and in_array($request->newImage->extension(), $extensions)){
			...
			$image->move('backend/images/category_images/', $fileName);
			$uploadImage = 'backend/images/category_images/'.$fileName; 
		}	else{
			$uploadImage = '';
		}	
		...
		if($request->hasFile('newIcon') and in_array($request->newIcon->extension(), $extensions)){
			...
			$icon->move('backend/images/category_icons/', $iconName);
			$uploadIcon = 'backend/images/category_icons/'.$iconName; 
		}	else{
			$uploadIcon = '';
		}
	...
	public function addsubcategory(Request $request){		
		...
		return view("backend.categories.add_subcategory",$title)->with('result', $result);
	}
