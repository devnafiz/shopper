...
class AdminController extends Controller
{
    public function dashboard(Request $request){
		...
		return view("backend.dashboard",$title)->with('result', $result);
		}
	...
	public function login(){
		if (Auth::check()) {
		  return redirect('/admin/dashboard/this_month');
			...
			return view("backend.login",$title);
		}
	}
	...
	public function admins(Request $request){
		...
		return view("backend.admins.list_admin",$title)->with('result', $result);
		}
	}
	...
	public function addadmins(Request $request){
		...
		return view("backend.admins.add_admins",$title)->with('result', $result);
	...
	public function manageroles(Request $request){
		...
		return view("backend.admins.manageRole",$title)->with('result', $result);
		}
	}
	...
	public function addadmintype(Request $request){
		...
		return view("backend.admins.addadmin_type",$title)->with('result', $result);
	}
	...
	public function addrole(Request $request){
		...
		$result['data'] = $result2;
		return view("backend.admins.admin_addrole",$title)->with('result', $result);
		}
	}
