...
class AdminSiteSettingController extends Controller
{
	...
	public function languages(Request $request){
		...
		return view("backend.language.language_list",$title)->with('result', $result);
		}
	}
	...
	public function addlanguages(Request $request){
		...
		return view("backend.language.add_languages",$title);
	}
	...
	public function setting(Request $request){
		if(session('general_setting_update')==0){
			...
			return view("backend.admins.settings",$title)->with('result', $result);
		}
	}
