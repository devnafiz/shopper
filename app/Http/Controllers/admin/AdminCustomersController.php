...
class AdminCustomersController extends Controller
{
	...
	public function customers(Request $request){
		...
		return view("backend.customer.customers",$title)->with('customers', $customerData);
		}
	}
	...
	public function addcustomers(Request $request){
		...
		return view("backend.customer.add_newcustomer",$title)->with('customers', $customerData);
		}
	}
	...
	public function addaddress(Request $request){
		...
		return view("backend.customer.add_address",$title)->with('data', $customerData);
		}
	}
