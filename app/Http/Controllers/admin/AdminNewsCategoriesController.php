...
class AdminNewsCategoriesController extends Controller
{
	...
	public function newscategories(){
		...
		return view("backend.news.news_category_list",$title)->with('listingCategories', $listingCategories);
		}
	}
	...
	public function addnewscategory(Request $request){
		...
		return view("backend.news.add_news_category",$title)->with('result', $result);
		}
	}
