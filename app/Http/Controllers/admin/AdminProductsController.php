...
class AdminProductsController extends Controller
{
	...
	public function products(Request $request){
		...
		return view("backend.products.products",$title)->with('results', $results);
		}
	}
	...
	public function addproduct(Request $request){
		...
		return view("backend.products.add_product", $title)->with('result', $result);
		}
	}
	...
	public function addnewproduct(Request $request){
		...
		if($request->hasFile('products_image') and in_array($request->products_image->extension(), $extensions)){
			...
			$image->move('backend/images/products/', $fileName);
			$uploadImage = 'backend/images/products//'.$fileName; 
		}else{
			$uploadImage = '';
		}	
	...
	public function addinventory(Request $request){
		...
		return view("backend.products.add_inventory", $title)->with('result', $result);
	...
	public function addproductimages(Request $request){
		...
		return view("backend.products.add_productimages", $title)->with('result', $result);
	...
	public function manageoptionsvalues(Request $request){
		...
		return view("backend.products.manageoptionvalue",$title)->with('result', $data);
	...
	public function attributes(Request $request){
		...
		return view("backend.products.attributes",$title)->with('result', $result);
	...
	public function addoptions(Request $request){
		...
		if(session('products_view')==0){
			...
			return view("backend.products.addoptions",$title)->with('result', $result);
	...
	public function manageoptions(Request $request){		
		...
		return view("backend.products.manageoption",$title)->with('result', $result);
