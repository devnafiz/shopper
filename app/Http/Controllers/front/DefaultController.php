...
class DefaultController extends DataController
{
	...
	public function index(Request $request){
		...
		//echo "<pre>";print_r($result['commonContent']);die;
		...
		//dd($result['news']);
		//news
		//Automobile And motorcycla
		$myVar = new DataController();
		$data = array('page_number'=>'0', 'type'=>'', 'categories_id'=>30, 'limit'=>10, 'min_price'=>$min_price, 'max_price'=>$max_price);
		$simliar_products = $myVar->products($data);
		$result['automobile_products'] = $simliar_products;
	...
	public function ContactUs(Request $request){
		...
		return view("frontend.contact", $title)->with('result', $result); 
	}
